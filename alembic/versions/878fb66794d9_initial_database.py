...
Revision ID: 878fb66794d9
Revises:
Create Date: 2024-05-10 17:15:09.442274

"""
from alembic import op
import sqlalchemy as sa
from sqlalchemy_utils.types.uuid import UUIDType  # type: ignore
from sqlalchemy_utils.types.encrypted.encrypted_type import StringEncryptedType  # type: ignore
from sqlalchemy_utils.types.ip_address import IPAddressType  # type: ignore
from app.db.custom_types.longtext import LongText
from app.db.custom_types.scopes import Scopes

# revision identifiers, used by Alembic.
revision = '878fb66794d9'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_file_asset_file_name'), 'file_asset', ['file_name'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_table('gcft')
    op.drop_index(op.f('ix_data_bucket_bucket_prefix'), table_name='data_bucket')
