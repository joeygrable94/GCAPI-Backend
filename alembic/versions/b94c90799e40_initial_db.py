...
Revision ID: b94c90799e40
Revises:
Create Date: 2024-05-02 10:54:44.894207
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_client_bucket_bucket_name'), 'client_bucket', ['bucket_name'], unique=False)
    op.create_index(op.f('ix_client_bucket_object_key'), 'client_bucket', ['object_key'], unique=False)
    ...
    op.create_index(op.f('ix_client_report_title'), 'client_report', ['title'], unique=True)
    ...
    op.create_index(op.f('ix_go_a4_measurement_id'), 'go_a4', ['measurement_id'], unique=True)
    ...
    op.create_index(op.f('ix_go_cloud_project_name'), 'go_cloud', ['project_name'], unique=True)
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.Column('address', sqlalchemy_utils.types.ip_address.IPAddressType(length=50), nullable=False),
    ...
    op.create_index(op.f('ix_file_asset_caption'), 'file_asset', ['caption'], unique=False)
    op.create_index(op.f('ix_file_asset_filename'), 'file_asset', ['filename'], unique=True)
    ...
    op.create_index(op.f('ix_go_a4_stream_stream_id'), 'go_a4_stream', ['stream_id'], unique=True)
    op.create_index(op.f('ix_go_a4_stream_title'), 'go_a4_stream', ['title'], unique=True)
    ...
    op.create_index(op.f('ix_go_sc_country_title'), 'go_sc_country', ['title'], unique=False)
    ...
    op.create_index(op.f('ix_go_sc_device_title'), 'go_sc_device', ['title'], unique=False)
    ...
    op.create_index(op.f('ix_go_sc_query_title'), 'go_sc_query', ['title'], unique=False)
    ...
    op.create_index(op.f('ix_go_sc_searchappearance_title'), 'go_sc_searchappearance', ['title'], unique=False)
    ...
    op.create_index(op.f('ix_gcft_snap_snap_name'), 'gcft_snap', ['snap_name'], unique=False)
    op.create_index(op.f('ix_gcft_snap_snap_slug'), 'gcft_snap', ['snap_slug'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_go_sc_searchappearance_title'), table_name='go_sc_searchappearance')
    ...
    op.drop_index(op.f('ix_file_asset_filename'), table_name='file_asset')
    ...
    op.drop_index(op.f('ix_client_bucket_object_key'), table_name='client_bucket')
    op.drop_index(op.f('ix_client_bucket_bucket_name'), table_name='client_bucket')
