...
Revision ID: d28396633077
Revises:
Create Date: 2023-04-14 00:31:21.291943
...
def upgrade() -> None:
    ...
    sa.Column('ps_unit', sa.String(length=16), nullable=False),
    ...
    sa.Column('fcp_unit', sa.String(length=16), nullable=False),
    ...
    sa.Column('lcp_unit', sa.String(length=16), nullable=False),
    ...
    sa.Column('cls_unit', sa.String(length=16), nullable=False),
    ...
    sa.Column('si_unit', sa.String(length=16), nullable=False),
