...
Revision ID: 6e7e0054b940
Revises:
Create Date: 2023-09-14 20:04:59.771724
...
def upgrade() -> None:
    ...
    sa.Column('serverhost', sa.String(length=255), nullable=False),
    ...
    sa.Column('client_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.ForeignKeyConstraint(['client_id'], ['client.id'], ),
    sa.PrimaryKeyConstraint('bucket_name'),
    sa.UniqueConstraint('id'),
    ...
    sa.Column('client_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.ForeignKeyConstraint(['client_id'], ['client.id'], ),
    sa.PrimaryKeyConstraint('group_slug'),
    mysql_engine='InnoDB'
    )
    ...
    op.create_index(op.f('ix_go_a4_property_id'), 'go_a4', ['property_id'], unique=False)
    ...
    sa.Column('isp', sa.String(length=255), nullable=False),
    ...
    op.create_index(op.f('ix_ipaddress_isp'), 'ipaddress', ['isp'], unique=False)
    op.create_index(op.f('ix_ipaddress_location'), 'ipaddress', ['location'], unique=False)
    ...
    sa.ForeignKeyConstraint(['geocoord_id'], ['geocoord.id'], ),
    sa.ForeignKeyConstraint(['image_id'], ['file_asset.id'], ),
    sa.PrimaryKeyConstraint('snap_slug'),
    ...
    sa.Column('created_on', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_on', sa.DateTime(timezone=True), nullable=False),
    sa.Column('corpus', mysql.LONGTEXT(), nullable=False),
    sa.Column('rawtext', mysql.LONGTEXT(), nullable=False),
    sa.Column('website_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    ...
    sa.Column('updated_on', sa.DateTime(timezone=True), nullable=False),
    sa.Column('session_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.Column('reporting_id', sa.String(length=32), nullable=True),
    ...
    sa.Column('updated_on', sa.DateTime(timezone=True), nullable=False),
    sa.Column('session_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.Column('referrer', sa.String(length=2048), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_ipaddress_location'), table_name='ipaddress')
