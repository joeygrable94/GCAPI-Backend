...
from app.models import ClientWebsite, User, UserClient, Website
...
async def test_delete_go_sc_property_metric_by_id_as_superuser(
    client: AsyncClient,
...
async def test_delete_go_sc_property_metric_by_id_as_employee(
    client: AsyncClient,
    db_session: AsyncSession,
