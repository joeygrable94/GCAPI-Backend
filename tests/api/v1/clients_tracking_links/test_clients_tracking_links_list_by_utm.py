...
async def test_list_all_client_reports_as_superuser_by_utm_campaign(
    client: AsyncClient,
...
async def test_list_all_client_reports_as_superuser_by_utm_medium(
    client: AsyncClient,
    db_session: AsyncSession,
    admin_token_headers: Dict[str, str],
) -> None:
...
async def test_list_all_client_reports_as_superuser_by_utm_source(
    client: AsyncClient,
    db_session: AsyncSession,
    admin_token_headers: Dict[str, str],
) -> None:
...
async def test_list_all_client_reports_as_superuser_by_utm_content(
    client: AsyncClient,
    db_session: AsyncSession,
    admin_token_headers: Dict[str, str],
) -> None:
...
async def test_list_all_client_reports_as_superuser_by_utm_term(
    client: AsyncClient,
    db_session: AsyncSession,
    admin_token_headers: Dict[str, str],
) -> None:
