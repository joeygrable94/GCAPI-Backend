...
@pytest.mark.parametrize(
    ...
    ids=[
        "admin user delete any website page",
        "manager user delete assiged website page",
        "employee user delete assigned website page",
        "manager user fails on delete unassigned website page",
        "employee user fails on delete unassigned website page",
    ],
)
