...
from tests.utils.clients import assign_platform_to_client, create_random_client
...
async def test_clients_remove_random_platform_as_user(
    client_user: Any,
    status_code: int,
    client: AsyncClient,
    ...
    response: Response = await client.post(
        f"clients/{a_client.id}/remove/platform",
...
async def test_clients_remove_platform_as_user_missmatching_platform_id(
    client_user: Any,
    by_key_id: str,
    error_msg: str,
    client: AsyncClient,
...
async def test_clients_remove_platform_as_superuser_relation_not_found(
    client: AsyncClient,
    db_session: AsyncSession,
