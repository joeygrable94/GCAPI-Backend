...
async def test_list_go_property_gads_by_id_as_user(
    ...
    await create_random_go_ads_property(db_session, a_organization.id, a_platform.id)
    await create_random_go_ads_property(db_session, b_organization.id, a_platform.id)
...
async def test_list_go_property_gads_as_superuser_by_website_id(
    ...
    await assign_platform_to_organization(db_session, a_platform.id, a_organization.id)
    await assign_platform_to_organization(db_session, a_platform.id, b_organization.id)
    ...
    b_gads = await create_random_go_ads_property(db_session, b_organization.id, a_platform.id)
