...
async def test_organization_assign_random_platform_as_user(
    client_user: Any,
    status_code: int,
    client: AsyncClient,
...
async def test_organization_assign_platform_as_user_missmatching_platform_id(
    client_user: Any,
    by_key_id: str,
    error_msg: str,
    client: AsyncClient,
