...
class ErrorCode(str, Enum):
    ...
    # reports
    CLIENT_REPORT_EXISTS = "CLIENT_REPORT_EXISTS"
    CLIENT_REPORT_NOT_FOUND = "CLIENT_REPORT_NOT_FOUND"
    # tracking links
    TRACKING_LINK_EXISTS = "TRACKING_LINK_EXISTS"
    TRACKING_LINK_NOT_FOUND = "TRACKING_LINK_NOT_FOUND"
    TRACKING_LINK_UTM_PARAMS_INVALID = "TRACKING_LINK_UTM_PARAMS_INVALID"
    # notes
