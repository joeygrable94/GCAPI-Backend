...
class ErrorCode(str, Enum):
    ...
    # users
    USER_AUTH_REQUEST_PENDING = "USER_AUTH_REQUEST_PENDING"
    USER_AUTH_REQUEST_REFRESH_REQUIRED = "USER_AUTH_REQUEST_REFRESH_REQUIRED"
    USER_AUTH_REQUEST_INVALID_TOKEN = "USER_AUTH_REQUEST_INVALID_TOKEN"
    USER_PASSWORDS_MISMATCH = "USER_PASSWORDS_MISMATCH"
