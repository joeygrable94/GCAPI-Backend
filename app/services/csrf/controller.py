...
from .errors import InvalidHeaderError, MissingTokenError, TokenValidationError
...
class CsrfProtect(CsrfConfig):
    def generate_csrf_tokens(self, secret_key: str | None = None) -> tuple[str, str]:
        ...
        serializer = URLSafeTimedSerializer(secret_key, salt=csrf_settings.csrf_salt)
    ...
    async def validate_csrf(
        ...
        :param cookie_key: (Optional) field name for CSRF token field stored in cookies
