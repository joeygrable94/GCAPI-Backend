...
class Settings(BaseSettings):
    ...
    SECRET_KEY: str = os.environ.get('SECRET_KEY', '54295fb3ad6577bf6ec55fc8a4e2ce86b4a490b5f1666f1e871e94855f6dc0a7')
    ...
    EMAIL_TEST_USER: EmailStr = os.environ.get('SMTP_EMAIL_TEST_USER', 'test@getcommunity.com')
    FIRST_SUPERUSER: EmailStr = os.environ.get('FIRST_SUPERUSER', 'admin@getcommunity.com')
    FIRST_SUPERUSER_PASSWORD: str = os.environ.get('FIRST_SUPERUSER_PASSWORD', 'password')
