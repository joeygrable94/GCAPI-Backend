...
async def test_read_client(
    ...
    gcclient: ClientRead = await create_random_client(db_session)
...
async def test_list_clients(
    ...
    client_1: ClientRead = await create_random_client(db_session)  # noqa: F841
    client_2: ClientRead = await create_random_client(db_session)  # noqa: F841
    client_3: ClientRead = await create_random_client(db_session)  # noqa: F841
