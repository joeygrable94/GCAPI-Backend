...
class GoogleSearchConsoleQuery(TableBase):
    __tablename__ = "go_sc_query"
    ...
    def __repr__(self) -> str:
        repr_str = f"GoogleSearchConsoleQuery(GSCID[{self.gsc_id}], C={self.clicks} I={self.impressions} CTR={self.ctr} Pos={self.position})"
        return repr_str
