...
class GoogleSearchConsoleCountry(TableBase):
    __tablename__ = "go_sc_country"
    keys = Column(String(10), nullable=False)
    ...
    def __repr__(self) -> str:
        repr_str = f"GoogleSearchConsoleCountry(GSCID[{self.gsc_id}], C={self.clicks} I={self.impressions} CTR={self.ctr} Pos={self.position})"
        return repr_str
