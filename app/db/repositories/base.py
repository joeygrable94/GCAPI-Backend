import abc
from typing import Generic, TypeVar, Type, Dict, List, Mapping
...
class BaseRepository(Generic[SCHEMA_CREATE, SCHEMA_UPDATE, SCHEMA_READ, TABLE], metaclass=abc.ABCMeta):
